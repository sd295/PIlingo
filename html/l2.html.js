...
const lessonContent = {
    ...
    minigame: {
    gameType: 'code-typer',
    title: "Challenge: Make a Heading",
    prompt: "Create a level 1 heading that says 'Welcome to Norway'. Type the HTML exactly as shown below.",
    
    solution: `<h1>Welcome to Norway</h1>`
}
